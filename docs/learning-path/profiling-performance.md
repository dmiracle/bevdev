...
Natural trigger: once the dungeon scales up (large maps, many entities) or enemies/AI arrive (Phase 7), giving real frame-time questions to investigate. Until then this is a stub.
